...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        CANDIDATOS = [
             os.path.join(INPUT_DIR_BASE, "datosColombia.csv"),
        ]
        ...
        map_headers = {
          "fecha": "date", "temperatura": "t", "humedad": "rh", # <-- Se quitó "hora": "time"
        ...
        for col in ["T", "RH", "Light", "CO2", "PM2_5"]:
